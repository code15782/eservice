      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
        <ul class="navbar-nav navbar-nav-hover mx-auto">
          ...
          <li class="nav-item mx-2">
            <a href="<?= $base_url ?>Eservice_teacher/index" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" role="button">
            บริหารจัดการ มคอ.
            </a>
          </li>

          <li class="nav-item mx-2">
            <a href="<?= $base_url ?>Eservice_teacher/list" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" role="button">
            รายวิชาของฉัน
            </a>
          </li>
